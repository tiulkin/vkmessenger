...
Ext.define('VKM.view.MessageItem', {
    extend: 'Ext.dataview.component.DataItem',
    alias: 'widget.messageItem',
    ...
    updateRecord: function(record) {
        ...
        if(record.get('did')!=0)
        {
            ...
            var messageBody=Ext.String.ellipsis(record.get('body'),70,true)
            ...
            //this.down('#body').addCls('videoIconCls');
            // this.down('#body').addCls('photoIconCls');
            // this.down('#body').addCls('musicIconCls');
            // this.down('#body').addCls('documentIconCls');
            var photo='';
            var video='';
            var document='';
            var audio='';
